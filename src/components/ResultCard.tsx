...
export default function ResultCard({ result, provider: manualProvider, onReset }: Props) {
  ...
  return (
    <div className="w-full bg-white/[0.01] backdrop-blur-sm border border-white/[0.08] rounded-2xl p-5 animate-in slide-in-from-bottom-4 duration-300 group/card hover:border-white/20 transition-all">
